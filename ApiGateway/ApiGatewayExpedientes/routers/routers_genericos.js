...
router.post("/expedientes/:id/convocados", ValidacionExpedientes,views_genericos.CrearConvocados)
router.post("/expedientes/:id/convocados/:identificacion", ValidacionExpedientes,views_genericos.AgregarConvocados)
router.post("/expedientes/:id/conciliadores/:id2", ValidacionExpedientes,views_genericos.AgregarConciliadores)
router.post("/expedientes/:id/estudiantes/:id2", ValidacionExpedientes,views_genericos.AgregarEstudiantes)
router.post("/expedientes/:id/citaciones", ValidacionExpedientes,views_genericos.CrearCitaciones);
router.post("/expedientes/:id/citaciones/:id_citacion/notificar",ValidacionExpedientes, views_genericos.EnviarNotificacionCitacion);
router.post("/citaciones/:id/personas/:id_persona",ValidacionExpedientes,views_genericos.CitarPersonas);
router.post("/expedientes/:id/resultados", ValidacionExpedientes,views_genericos.CrearResultado)
router.post("/expedientes/:id/enviar_resultados",ValidacionExpedientes, views_genericos.EnviarResultado)



router.delete("/citaciones/:id/personas/:id_persona",views_genericos.EliminarPersonaDeCitacion);
router.delete("/expedientes/:id/personas/:id_relacion",ValidacionExpedientes,views_genericos.EliminarPersonaCaso);
...
router.get("/expedientes/:id/hechos", ValidacionExpedientes,views_genericos.ListarHechosCaso);
...
router.post("/expedientes/:id/documentos/:id_documento",ValidacionExpedientes,archivo.uploadMiddleware, views_genericos.CambiarDocumentoCaso);
router.get("/resultados/:id",archivo.uploadMiddleware, views_genericos.DescargarResultados);

router.post("/expedientes/:id/respuestas", ValidacionExpedientes,views_genericos.CrearRespuestas);
router.post("/reportes/:id/", views_genericos.GenerarReportes)
router.post("/expedientes/:id/seguimientos",ValidacionExpedientes, views_genericos.CrearSeguimientoCaso);
router.post("/expedientes/:id/estado",ValidacionExpedientes,views_genericos.CambiarEstadoExpediente)

router.patch("/expedientes/:id/resultados/:id_resultado",ValidacionExpedientes,archivo.uploadMiddleware, views_genericos.CargarResultadoCaso);




router.patch("/expedientes/:id",ValidacionExpedientes,views_genericos.ActualizarExpediente)
...
router.post("/expedientes/:id/resultados/:id_resultado/formato", ValidacionExpedientes,views_genericos.DescargarFormatoResultado);
router.post("/expedientes/:id/citaciones/:id_citacion/personas/:id_relacion/formato", ValidacionExpedientes,views_genericos.DescargarFormatoCitacion);
router.post("/personas/formato", views_genericos.DescargarTemplates);
// turnos fecha

router.get("/expedientes/:id/turnos/:fecha",ValidacionExpedientes, views_genericos.TurnosFecha);
