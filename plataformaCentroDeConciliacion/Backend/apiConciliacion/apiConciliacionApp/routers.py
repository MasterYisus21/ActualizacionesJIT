...
router.register(r'estratos_socioeconomicos',Estrato_socioeconomicoViewSet,basename='Estrato_socioeconomico')
...
router.register(r'historicos_solicitud',Historico_solicitudViewSet,basename='Historico_solicitud')
...
router.register(r'tipos_cliente',Tipo_clienteViewSet,basename='Tipo_cliente')
router.register(r'preguntas',PreguntaViewSet,basename='Preguntas')
router.register(r'medios_conocimiento',Medio_conocimientoViewSet,basename='Medio_conocimiento')
...
# router.register(r'documentos_prueba',Documentos_pruebaViewSet,basename='Inicio_conflicto')
