                ...
                <div className='registro-personas mt-2'>
                    ...
                    <div className='container d-grid gap-2 mb-2'>
                        ...
                        <div className='row gap-3 ps-3 px-3'>
                            <select className="form-control col" aria-label="Default select example" defaultValue="">
                    ...
                    <div className='container d-grid gap-1 mb-2'>
                        ...
                        <div className=' d-grid gap-2 ps-3 px-3 mb-2'>
                            ...
                            <div className='row gap-3'>
                                <select className="form-select col" aria-label="Default select example" defaultValue="">
                            ...
                            <div className='row gap-3'>
                                ...
                                <select className="form-select col" aria-label="" defaultValue="">
