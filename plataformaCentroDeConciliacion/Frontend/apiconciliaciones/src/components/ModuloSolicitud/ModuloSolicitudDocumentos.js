...
import './css/ModuloSolicitudDocumentos.css'

import axios from 'axios'
import config from '../../config.json'
import FileDownload from 'js-file-download'

function ModuloSolicitudDocumentos() {
          ...
          {documentos.map((dato) => {
            return (
              <tr>
                ...
                <td className='d-flex justify-content-center'><ThreePositionSwitch key={dato["Id"]} initialValue={dato["Tipo_estado_Id"]["Id"]} id={dato["Id"]} /></td>
...
export default ModuloSolicitudDocumentos