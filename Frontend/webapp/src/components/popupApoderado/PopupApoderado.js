...
export default function PopupApoderado({text, setEstado, estado, apoderadoid, setResultadosBusqueda, resultadosBusqueda, setPopup, popup, newApoderado}){
        ...
        if (apoderadoid) { 
          ...
          axiosTokenInstanceApiExpedientes({
            ...
            .then(result => {
              ...
              document.getElementById("fechaExpedicion").value = result.data["fecha_expedicion"];
              document.getElementById("lugarExpedicion").value = result.data["lugar_expedicion"];
                ...
                <div className='form-popup'>
                  ...
                  <div className="col-detalle-solicitud">
                    ...
                    <div className="wrapp-botones">
                        <button className='botones-popup' onClick={() => {}}>Guardar</button>
                        <button className='botones-popup' onClick={() => {setEstado(!estado)}}>Cancelar</button>
                    </div>
                </div>
            </div>
            </Form>
