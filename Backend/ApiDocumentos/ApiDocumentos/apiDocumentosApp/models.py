...
class Documento(models.Model):
    ...
    nombre= models.CharField(max_length=210,blank=True,default="nombre", null=False)
    ...
    documento = models.FileField(upload_to='documentos/', max_length=220, blank=True,null=True)
