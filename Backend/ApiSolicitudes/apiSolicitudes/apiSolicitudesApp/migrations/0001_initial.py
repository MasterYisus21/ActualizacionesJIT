# Generated by Django 4.1.3 on 2023-03-01 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('estado', models.BooleanField(blank=True, default=True)),
                ('nombre', models.CharField(blank=True, max_length=210)),
                ('fecha_registro', models.DateField(auto_now=True)),
                ('documento', models.FileField(blank=True, max_length=210, null=True, upload_to='documentos/')),
                ('solicitud_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='apiSolicitudesApp.solicitud')),
            ],
            options={
