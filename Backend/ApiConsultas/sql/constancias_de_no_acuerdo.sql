...
SUM(CASE WHEN tipo_resultado_id_id = 5 THEN 1 ELSE 0 END) AS Resultados, semestre
FROM (

SELECT e.id as expedientes,r.id as resultado,r.tipo_resultado_id_id, e.fecha_registro,
CASE
